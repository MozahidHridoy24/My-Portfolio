    ...
    <section className="relative overflow-hidden bg-base-100 py-20 px-6 md:px-20">
      ...
      <div className="grid gap-6 md:grid-cols-2 max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-base-200 rounded-xl p-6 shadow-md hover:shadow-xl transition"
        >
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-300">
            ...
            writing clean, scalable code — I strive to grow every day. I believe
            the best developers are always students first.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-300">
            When I’m not coding, you’ll find me on the cricket field or watching
            a thrilling football match. I value discipline, strategy, and
            teamwork — in sports and in code.
          </p>
        </motion.div>
      </div>
    </section>
